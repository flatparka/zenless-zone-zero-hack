...
![Downloads](https://img.shields.io/badge/Downloads-65k+-orange?style=flat-square)

Zenless Zone Zero Hack - game hack and trainer with full feature set. Works with the latest game update.
...
- Works with Steam, Epic and standalone versions
...
Yes, compatible with Steam, Epic and standalone versions.
